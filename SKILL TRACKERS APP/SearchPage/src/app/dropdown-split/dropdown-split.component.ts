...
upload() 
{
  ...
  {     
    ...
    let responseData = this.httpObj.get("http://localhost:8068/associate/all");
    responseData.subscribe((response) => {
     ...
     let responseData2 = this.httpObj.get("http://localhost:8068/associateSkills/all");
  ...
  saveAssociate()
  {
    ...
    this.httpObj.post("http://localhost:8068/saveAssocaite",
    {
...
openModal(){
  ...
  onSubmit(params)
 {
   ...
   let responseData = this.httpObj.get("http://localhost:8068/skills/all");
    responseData.subscribe((response) => {
      ...
      this.httpObj.post("http://localhost:8068/saveSkills",this.skillArray
  ...
  selected(option :string)
  {
    ...
    if(this.selectedOption == 'All Employee')
    {
