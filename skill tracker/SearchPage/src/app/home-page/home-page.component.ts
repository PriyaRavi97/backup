...
export class HomePageComponent implements OnInit {
  ...
  onSubmit(params)
  {
    ...
    let httpHeaders = new HttpHeaders({
      ...
      let options = {
        headers: httpHeaders};
    this.httpObj.put("http://localhost:8078/updateHR",
    {
...
,options).subscribe(data  => {console.log("PUT Request is successful ", data);
  ...
  checkEmail(uname : any, upassword : any) 
  {
    ...
    let responseData = this.httpObj.get("http://b4ibm03.iiht.tech:8078/hrDetails/all");
  ...
  setNewPassword()
  {
    if(this.setPass == this.setAgainPass)
    {
      ...
      let httpHeaders = new HttpHeaders({
        ...
        let options = {
          headers: httpHeaders};
      this.httpObj.put("http://b4ibm03.iiht.tech:8078/updateHR",
      {
